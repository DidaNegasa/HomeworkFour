...
public class Professor extends Person {
	...
	public Professor(String name, int egn, char gender, int age, int height, int weight,String title) {
	...
	public static class ProfessorGenerator {
		...
		private static String[] names = {"Petyr", "Ivan", "Mariya", "Lilly", "Georgi", "Petya","Popo","Mimi","Gigi"};
		...
		public static Professor make() {
			...
			return new Professor(name, egn, gender, age, height, weight, title);
		}
	}
}
